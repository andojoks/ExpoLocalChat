import type { ExamQuestion } from '@/domain/types';
export const SEED_QUESTIONS: ExamQuestion[] = [
  ...
  },
  {
    ...
    answerMarkdown: '$a=3\\text{ m s}^{-2}$ and $v=12\\text{ m s}^{-1}$.',
  ...
  },
  {
    ...
    answerMarkdown: '$\\frac{dy}{dx}=6x^2-10x$; gradient $=4$.',
